...
export const getPrimaryTenantBaseDomain = () =>
  isProductionRuntime()
    ? PRODUCTION_TENANT_BASE_DOMAIN
    : LOCAL_TENANT_BASE_DOMAIN;

export const getTenantBaseDomains = () =>
  new Set([
    PRODUCTION_TENANT_BASE_DOMAIN,
    ...(isProductionRuntime() ? [] : [LOCAL_TENANT_BASE_DOMAIN]),
  ]);

export const getReservedTenantSlugs = () => parseReservedTenantSlugs();
