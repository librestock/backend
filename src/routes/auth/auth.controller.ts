...
@ApiTags('Auth')
@ApiBearerAuth()
// These endpoints are authenticated reads, not credential-submission endpoints.
// Applying the standard API throttle avoids spurious 429s during normal app usage.
@StandardThrottle()
@Controller()
